 ...
 * under the License.
 */
/*global LinkedNotebook */
(function( exports ) {
    'use strict';

    var Evernote = exports.Evernote || (exports.Evernote = {});

    Evernote.LinkedNotebook = LinkedNotebook;
    ...
    exports.listBusinessNotebooks = function(callback) {
        ...
        self.getNoteStore().listLinkedNotebooks(function(err, linkedNotebooks) {
            ...
            for ( var i in linkedNotebooks ) {
                if (linkedNotebooks[i].businessId) {
                    businessNotebooks.push(linkedNotebooks[i]);
                }
            }
